...
<div className="text-center text-white">
    <div className="container p-3">
        <div className="mb-4 d-flex justify-content-evenly">
            ...
            <a className="btn btn-outline-light btn-floating m-1" href="https://github.com/twashke" title="Check out my GitHub!" target="_blank"  rel="noreferrer" role="button">{github}</a>
        </div>
    </div>
</div>
    )
